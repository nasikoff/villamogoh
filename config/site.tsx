...
export const about  = [
  {
    description: "База отдыха VILLAMOGOH расположена в горном районе и предлагает своим гостям возможность насладиться живописными видами гор, чистым воздухом и уединением от городской суеты. На территории базы есть уютные коттеджи, русская баня. Здесь можно провести время активно, занимаясь пргулками по горной местности, велоспортом или просто отдыхать, наслаждаясь природой. VILLAMOGOH идеальное место для отдыха в горах и погружения в атмосферу природы.",
  },
];
